  ...
  return (
    <div className="w-full h-full flex flex-col p-4">
      <div className="flex w-full justify-between items-center">
        <Image className="h-12 w-auto" src="/logo.png" alt="logo" width={120} height={120}></Image>
        <Image className="h-12 w-auto" src="/logo-kemendikbud.png" alt="logo" width={120} height={120}></Image>
      </div>
