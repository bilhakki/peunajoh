...
import { Participant } from "@/lib/db/schema/participants";
...
export default function Home() {
  ...
  async function getParticipant() {
    const data = await fetch(`${config.PUBLIC_API_URL}/api/participants`).then(
      (res) => res.json() as Promise<Participant[]>
    );
